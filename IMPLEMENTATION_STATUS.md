...
- ~~No GitHub Actions workflow~~ RESOLVED 2026-09-01 (Phase 22): `.github/workflows/ci.yml` now targets `laravel/` with quality, PHPUnit matrix, PostgreSQL, Playwright, and source-scan jobs. It previously pointed at the abandoned `app/` Next.js tree. Validated locally; not yet executed on GitHub Actions.
