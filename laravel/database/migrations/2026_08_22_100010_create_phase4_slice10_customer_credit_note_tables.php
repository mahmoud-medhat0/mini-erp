...
return new class extends Migration
{
    ...
    {
        Schema::create('customer_credit_note', function (Blueprint $table): void {
        ...
        Schema::create('customer_credit_note_line', function (Blueprint $table): void {
            $table->uuid('id')->primary();
            $table->uuid('customer_credit_note_id');
            $table->unsignedBigInteger('line_no');
            $table->uuid('customer_invoice_line_id')->nullable();
            $table->uuid('sales_return_line_id')->nullable();
            ...
            $table->foreign('customer_credit_note_id')->references('id')->on('customer_credit_note')->onDelete('cascade');
            $table->foreign('customer_invoice_line_id')->references('id')->on('customer_invoice_line')->onDelete('restrict');
            $table->foreign('sales_return_line_id')->references('id')->on('sales_return_line')->onDelete('restrict');
            ...
            $table->unique(['customer_credit_note_id', 'line_no']);
            $table->index(['customer_credit_note_id', 'product_id']);
        });
    }
    ...
    {
        Schema::dropIfExists('customer_credit_note_line');
        Schema::dropIfExists('customer_credit_note');
    }
};
