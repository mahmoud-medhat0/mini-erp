...
class AccountingCoreSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $accounts = [
            ...
            [
                'code' => '3300',
                'name' => ['en' => "Partners' Capital", 'ar' => 'رأس مال الشركاء'],
                'type' => 'equity',
                'type_code' => 'EQUITY',
                'nature' => 'credit',
                'group_code' => '3000',
            ...
            [
                'code' => '2640',
                'name' => ['en' => 'Partner Loans Payable', 'ar' => 'قروض الشركاء المستحقة'],
                'type' => 'liability',
                'type_code' => 'LIABILITY_CURRENT',
                'nature' => 'credit',
                'group_code' => '2000',
            ...
            [
                'code' => '1850',
                'name' => ['en' => 'Employee Loans Receivable', 'ar' => 'سلف وقروض الموظفين'],
                'type' => 'asset',
                'type_code' => 'ASSET_CURRENT',
                'nature' => 'debit',
                'group_code' => '1000',
            ...
            [
                'code' => '2630',
                'name' => ['en' => 'Withholding Tax Payable', 'ar' => 'ضريبة الخصم والإضافة المستحقة'],
                'type' => 'liability',
                'type_code' => 'LIABILITY_CURRENT',
                'nature' => 'credit',
                'group_code' => '2000',
        ...
        if (Schema::hasTable('accounting_account_mapping')) {
            $mappings = [
                ...
                'employee_loan_receivable' => ['account_code' => '1850', 'description' => 'Default employee loans and advances receivable account'],
                'withholding_tax_payable' => ['account_code' => '2630', 'description' => 'Default withholding tax payable account'],
                'partner_capital_account' => ['account_code' => '3300', 'description' => 'Default partners capital control account'],
                'partner_loan_payable' => ['account_code' => '2640', 'description' => 'Default partner loans payable control account'],
