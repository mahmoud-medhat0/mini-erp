...
return [
    ...
    'modules' => [
        ...
        'purchasing' => ['view', 'create', 'edit', 'delete', 'submit', 'approve', 'post', 'cancel', 'reverse', 'export', 'print', 'returns', 'adjustment_notes'],
        'inventory' => ['view', 'create', 'edit', 'delete', 'approve', 'post', 'export', 'print'],
        'equipment' => ['view', 'create', 'edit', 'delete', 'export'],
        'rentals' => ['view', 'create', 'edit', 'delete', 'submit', 'approve', 'post', 'cancel', 'export', 'print'],
        ...
        'fixedAssets' => ['view', 'create', 'edit', 'delete', 'post', 'reverse', 'export'],
