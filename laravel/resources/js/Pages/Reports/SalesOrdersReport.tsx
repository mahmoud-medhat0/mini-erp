...
export default function SalesOrdersReport({ reportData, filters, customers, products }: SalesOrdersReportProps) {
    ...
    return (
        <AppLayout active="reports.sales-orders">
            <Head title="Sales Orders Report / تقرير أوامر البيع" />

            <div className="py-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
                <PageHeader
                    title="Sales Orders Register / سجل أوامر البيع"
                    description="Read-only operational register of all sales orders"
                />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <Card className="p-4 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
                        <div className="text-xs font-medium text-slate-500">Total Sales Orders / إجمالي الأوامر</div>
                                ...
                                {reportData.rows.length === 0 ? (
                                    <tr>
                                        <td colSpan={7} className="p-4 text-center">
                                            <EmptyState title="No sales orders found / لا توجد أوامر بيع" />
                                        </td>
                                    </tr>
                                ) : (
