...
export default function CustomersIndex({ locale, filters }: CustomersProps) {
  ...
  const columns = useMemo(() => [
    ...
    { data: 'actions', name: 'actions', title: pageDict.actions, orderable: false, searchable: false, width: '80px', className: 'text-end' },
  ], [pageDict]);
  ...
  } as Record<string, (data: any, type: any, row: any) => ReactElement>), [dict, pageDict, accDict, locale, can]);
  ...
  return (
    <AppLayout active="customers.index" pagination="none">
      ...
      <Modal
        ...
        title={editingCustomer ? pageDict.editCustomer : pageDict.createNewCustomer}
