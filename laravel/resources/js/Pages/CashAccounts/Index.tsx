  ...
  return (
    <AppLayout active="cash-accounts.index">
      ...
      <Modal
        ...
        title={editingAccount ? dict.app.pages.cashAccounts.editCashAccount : dict.app.pages.cashAccounts.createCashAccount_2}
      ...
      >
            <form id="cash-account-form" onSubmit={submit} className="space-y-4">
