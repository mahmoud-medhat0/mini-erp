  ...
  return (
    <AppLayout active="customer-credit-notes.index">
      ...
      <Modal
        isOpen={showModal}
        onClose={closeModal}
        title={editingNote ? dict.app.pages.salesCustomerCreditNotes.editCustomerCreditNote : dict.app.pages.salesCustomerCreditNotes.createCustomerCreditNote_2}
        ...
        footer={
          <>
            ...
            <button
              type="submit"
              form="customer-credit-note-form"
              disabled={processing}
      ...
      >
            <form id="customer-credit-note-form" onSubmit={handleSubmit} className="space-y-4">
