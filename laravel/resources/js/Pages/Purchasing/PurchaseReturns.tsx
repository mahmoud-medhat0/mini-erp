  ...
  return (
    <AppLayout active="purchase-returns.index">
      ...
      <Modal
        isOpen={showModal}
        onClose={closeModal}
        title={editingReturn ? dict.app.pages.purchasingPurchaseReturns.editPurchaseReturn : dict.app.pages.purchasingPurchaseReturns.createPurchaseReturn_2}
      ...
      >
            <form id="purchase-return-form" onSubmit={handleSubmit} className="space-y-4">
