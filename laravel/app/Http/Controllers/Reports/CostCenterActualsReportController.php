...
use App\Application\Reports\CostCenterActualsCsvExporter;
...
class CostCenterActualsReportController extends Controller
{
    public function __construct(
        private readonly CostCenterActualsCsvExporter $csvExporter,
        private readonly ReportPageOptions $options,
        private readonly FinancialPeriodReportOptions $periodOptions,
    ) {}

    public function index(Request $request, CostCenterActualsReportService $service): Response
    {
