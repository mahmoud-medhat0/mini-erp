...
class AccrualScheduleController extends Controller
{
    public function __construct(
        private readonly AccrualScheduleService $service,
        private readonly AccrualSchedulePageData $pageData,
    ) {}
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return back()->with('success', __('Accrual schedule saved.'));
    }
    ...
    public function update(Request $request, string $id): RedirectResponse
    {
        ...
        return back()->with('success', __('Accrual schedule updated.'));
    }
    ...
    public function submit(Request $request, string $id): RedirectResponse
    {
        ...
        return back()->with('success', __('Accrual schedule submitted.'));
    }
    ...
    public function approve(Request $request, string $id): RedirectResponse
    {
        ...
        return back()->with('success', __('Accrual schedule approved.'));
    }

    public function postEntry(Request $request, string $id, string $entryId): RedirectResponse
    {
        $this->service->postEntry($id, $entryId, $request->user()?->id);

        return back()->with('success', __('Accrual entry posted.'));
    }
    ...
    public function cancel(Request $request, string $id): RedirectResponse
    {
        ...
        return back()->with('success', __('Accrual schedule cancelled.'));
    }
    ...
    private function validatedSchedule(Request $request, bool $isUpdate = false): array
    {
        return $request->validate([
            ...
            'accrued_liability_account_id' => [$isUpdate ? 'sometimes' : 'required', 'uuid', 'exists:account,id'],
