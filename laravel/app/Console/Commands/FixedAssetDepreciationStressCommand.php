...
use App\Console\Commands\Concerns\PreservesStressMappings;
...
{
    use GuardsStressExecution, PreservesStressMappings, ResolvesStressCurrency;
    ...
    public function handle(
        ...
        $this->reportStressRunTag($year);

        $mappingKeys = ['depreciation_expense', 'accumulated_depreciation'];
        $previousMappings = $this->captureGlobalStressMappings($mappingKeys);
        ...
        try {
            ...
            $this->restoreGlobalStressMappings($mappingKeys, $previousMappings);
        }
    }
}
