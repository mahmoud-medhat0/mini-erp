...
class SupplierAdjustmentNote extends Model
{
    use HasFactory, HasUuids;

    protected $table = 'supplier_adjustment_note';
    ...
    {
        return $this->hasMany(SupplierAdjustmentNoteLine::class, 'supplier_adjustment_note_id')->orderBy('line_no', 'asc');
    }
