...
| 4 | Sales & Purchasing | quotes→orders→delivery→invoices→returns/credit notes, GRN, 2/3-way match, approvals, credit limits | In progress - Slice 1 complete, Slice 2 prompt ready |
