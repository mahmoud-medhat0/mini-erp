...
| 4 | Sales & Purchasing | quotes→orders→delivery→invoices→returns/credit notes, GRN, 2/3-way match, approvals, credit limits | In progress - Slices 1-6 complete, Slice 7 decision prompt ready |
